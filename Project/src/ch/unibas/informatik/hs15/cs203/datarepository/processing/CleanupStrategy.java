...
interface CleanupStrategy {
	 ...
	 * After the cleanup, the repository and the MetaDataStorage are
	 * synchronized, so they have the same data.
	 * 
	 * @param storage
	 *            The storage to clean up.
	 * @param repo
	 *            The repo to which the storage belongs to.
