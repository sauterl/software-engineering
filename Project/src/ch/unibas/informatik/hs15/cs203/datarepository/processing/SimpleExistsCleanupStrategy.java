...
public class SimpleExistsCleanupStrategy implements CleanupStrategy {
	 ...
	 * 
	 * @see
	 * ch.unibas.informatik.hs15.cs203.datarepository.processing.CleanupStrategy
	 * #clean(ch.unibas.informatik.hs15.cs203.datarepository.processing.
	 * MetaDataStorage, java.nio.file.Path)
	 */
	@Override
