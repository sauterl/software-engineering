 ...
 * 
 * The CommandInterpeter delegates parsing the command to the {@link CommandParser}.
 * So the CommandInterpreter is basically responsible to call the correct part of the application's logic while
 * the {@link CommandParser} simply parses the given command line arguments.
 * 
 * @author Loris
 * 
 */
public class CommandInterpreter {
    ...
    /**
     * Creates a new {@link CommandInterpreter}.
     * Currently nothing more happens.
     */
    ...
    /**
     * Interprets the given command line arguments.
     * It is <i>highly</i> recommended to pass <i>directly</i> the command line arguments array to this
     * method.
    ...
    /**
     * Executes the ADD command of the data repository application.
     * The paramter <code>arguments</code> are the arguments for
     * the command ADD, without ADD itself.
     * It is highly recommended to only use the {@link CommandParser#lex(String[])} tokenizer. Since
     * this method relies on correctly parsed tokens in the <code>arguments</code>-list.
     * @param arguments The arguments of the command ADD, in tokenized list form.
     */
