...
/**
 * This is an interface for the completness detection methods used when this
 * programm runs as server
 * 
 */
public interface CompletenessDetection {
	 ...
	 * 
	 * @param properties
	 *            These are {@link #Properties} which contain the parameters for
	 *            the detection.
	 */
